package edu.stanford.thingengine.sabrina.ui;
...
import edu.stanford.thingengine.sabrina.R;
import edu.stanford.thingengine.sabrina.channels.Util;
import edu.stanford.thingengine.sabrina.service.AutoStarter;
import edu.stanford.thingengine.sabrina.service.RuleExecutor;
import edu.stanford.thingengine.sabrina.service.RuleExecutorService;


public class MainActivity extends ActionBarActivity {
    public static final String LOG_TAG = "thingengine.sabrina.UI";
    ...
    private void doActionView(Uri data) {
        if (!data.getScheme().equals("https") ||
                (!data.getHost().equals("vast-hamlet-6003.herokuapp.com") &&
                        !data.getHost().equals("sabrina.stanford.edu"))) {
