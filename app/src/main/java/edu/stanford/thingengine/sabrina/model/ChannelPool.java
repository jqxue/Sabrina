...
import edu.stanford.thingengine.sabrina.channels.android.NotificationManagerChannelFactory;
import edu.stanford.thingengine.sabrina.channels.android.SMSChannelFactory;
import edu.stanford.thingengine.sabrina.channels.generic.GenericChannelFactory;
import edu.stanford.thingengine.sabrina.channels.googlefit.GoogleFitChannelFactory;
import edu.stanford.thingengine.sabrina.channels.omlet.OmletChannelFactory;
...
public class ChannelPool extends ObjectPool<Channel, ChannelFactory> {
    ...
    public static final String LOG_TAG = "sabrina.Channels";
