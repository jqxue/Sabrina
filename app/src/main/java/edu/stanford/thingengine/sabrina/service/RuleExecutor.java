package edu.stanford.thingengine.sabrina.service;
...
import edu.stanford.thingengine.sabrina.BuildConfig;
...
import edu.stanford.thingengine.sabrina.exceptions.DuplicatedRuleException;
...
import edu.stanford.thingengine.sabrina.exceptions.UnexpectedPlaceholderException;
...
import edu.stanford.thingengine.sabrina.model.ObjectDatabase;
import edu.stanford.thingengine.sabrina.model.Rule;
import edu.stanford.thingengine.sabrina.model.RuleDatabase;
...
public class RuleExecutor extends EventSourceHandler {
    ...
    public void installRule(final JSONObject jsonRule, final edu.stanford.thingengine.sabrina.service.Callback<Rule> callback) {
        post(new Runnable() {
            public void run() {
    ...
    public void reloadRule(final String id, final edu.stanford.thingengine.sabrina.service.Callback<Rule> callback) {
        post(new Runnable() {
            @Override
            public void run() {
    ...
    public void deleteRule(final String id, final edu.stanford.thingengine.sabrina.service.Callback<Boolean> callback) {
        post(new Runnable() {
            @Override
            public void run() {
    ...
    private void doInstallRule(JSONObject jsonRule, edu.stanford.thingengine.sabrina.service.Callback<Rule> callback) {
        try {
    ...
    private void doReloadRule(String id, edu.stanford.thingengine.sabrina.service.Callback<Rule> callback) {
    ...
    private void doDeleteRule(String id, edu.stanford.thingengine.sabrina.service.Callback<Boolean> callback) {
        RuleDatabase db = RuleDatabase.get();
